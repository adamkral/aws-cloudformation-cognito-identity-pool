...
var resolveParamsType = function(params) {
  ...
  if (params.CognitoIdentityProviders) {
    // TODO: iterate over the array in case there is more cognito user pools
    toBoolean(params.CognitoIdentityProviders[0], "ServerSideTokenCheck");
  }
  return params
}
